...
echo %CYAN%[INFO]%NC% Installing WebP and Nano...
winget install -e --id Google.WebP --accept-source-agreements --accept-package-agreements
winget install -e --id GNU.Nano --accept-source-agreements --accept-package-agreements
